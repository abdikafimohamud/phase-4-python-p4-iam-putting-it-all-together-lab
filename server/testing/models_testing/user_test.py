...
class TestUser:
    ...
    def test_requires_username(self):
        ...
        with app.app_context():
            ...
            user = User()
            user.password_hash = "dummy"  # must set password or IntegrityError will fire for password instead
    ...
    def test_has_list_of_recipes(self):
        ...
        with app.app_context():
            ...
            user.password_hash = "securepass"  # ✅ set password

            db.session.add(user)
            db.session.flush()  # ✅ ensures user.id exists before linking recipes
